...
public final class MediaNavigationAccessoryPanel: ASDisplayNode {
    ...
    public init(context: AccountContext, presentationData: PresentationData, displayBackground: Bool = false, customTintColor: UIColor? = nil, compactCard: Bool = false) {
        self.containerNode = MediaNavigationAccessoryContainerNode(context: context, presentationData: presentationData, displayBackground: displayBackground, customTintColor: customTintColor, compactCard: compactCard)
