...
// nameless: Liquid Glass for settings blocks
                            ...
                            strongSelf.maskNode.image = SGLiquidGlassZone.settings.isEnabled ? nil : (hasCorners ? PresentationResourcesItemList.cornersImage(item.presentationData.theme, top: hasTopCorners, bottom: hasBottomCorners) : nil)
