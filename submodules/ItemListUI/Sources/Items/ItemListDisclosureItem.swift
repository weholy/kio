                ...
                if let strongSelf = self {
                    ...
                    case .blocks:
                        ...
                        if useGlass {
                            ...
                            // The rounded glass overlay already draws the card; the corners mask
                            // fills its notches with opaque blocksBackgroundColor (a gray block over
                            // the glass), so drop it entirely in glass mode.
