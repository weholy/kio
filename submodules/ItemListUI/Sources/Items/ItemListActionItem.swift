                    ...
                    switch item.style {
                        ...
                        case .blocks:
                            ...
                            if SGLiquidGlassZone.settings.isEnabled {
                                ...
                                // The rounded GlassBackgroundView already draws the section-card
                                // shape (26pt corners). The corners mask fills the notch area with
                                // opaque `blocksBackgroundColor`, which paints a gray block into the
                                // top/bottom corners on top of the glass — so drop it in glass mode.
