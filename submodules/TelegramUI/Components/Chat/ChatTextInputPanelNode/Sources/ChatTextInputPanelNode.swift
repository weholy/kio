...
//                    interfaceInteraction.finishMediaRecording(.dismiss)
    ...
    override public func updateLayout(
        ...
        // Official Telegram-iOS liquid glass only (GlassBackgroundView → UIGlassEffect)
        // .panel = UIGlassEffect(.regular)  |  .clear = UIGlassEffect(.clear)
        // No custom blur / no custom tint hacks.
