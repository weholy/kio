...
public final class PresentationTheme: Equatable {
    ...
    /// MARK: Megram — needed to make list surfaces translucent under glass and
    /// when a custom app-wide background is active.
    public func withUpdated(list: PresentationThemeList) -> PresentationTheme {
