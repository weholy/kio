...
func getAvailableAppBadges() -> [AppBadge] {
    return [
        .init(displayName: "nameless", assetName: "NamelessAppBadge")
    ]
}
...
struct AppBadgeSettingsView: View {
    ...
    private func onSelectBadge(_ badge: AppBadge) {
        ...
        let image = UIImage(bundleImageName: selectedBadge.assetName) ?? UIImage(bundleImageName: "NamelessAppBadge")
